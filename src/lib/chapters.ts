...
const DESCRIPTIONS: Record<string, string> = {
  "distribution-101": "The channels that connect hotels to guests — from global distribution systems and online travel agencies to brand websites — and the economics behind every booking path.",
  "hotel-technology": "Property management systems, central reservations, channel managers, revenue management, booking engines, and the integration challenges of a modern hotel tech stack.",
  "value-of-a-guest": "Customer lifetime value, net revenue per available room, acquisition costs, guest segmentation, and why not all bookings are created equal.",
  "digital-direct": "The direct booking wars, brand website optimization, search strategy, rate guarantees, and the fight to reduce third-party dependence.",
  "group-bookings": "Corporate meetings, conventions, social events — displacement analysis, contract negotiations, and digital platforms reshaping group sales.",
  "voice-and-walk-in": "Call centers, voice response systems, messaging channels, and walk-in strategy — where high-touch service meets complex, high-value reservations.",
  "loyalty-and-personalization": "Points programs as multibillion-dollar ecosystems — Marriott Bonvoy, Hilton Honors, Hyatt — and the shift toward personalization at scale.",
  "gds-travel-agents-managed-travel": "Global distribution system architecture, the travel advisor renaissance, travel management companies, corporate rate programs, and the forces reshaping intermediary channels.",
  ...
  "wholesale-deep-dive": "Bed banks, net rates, multi-layered supply chains, and the rate leakage problem that costs hotels millions in lost revenue.",
  "metasearch-deep-dive": "Google Hotel Ads, Trivago, bidding strategies, and how comparison shopping became the direct booking channel hotels didn't expect.",
